...
#使用真实数据测试
    #读取npy文件,lif2的输出，实际上conv3的输入是maxpool2的输出
    # input_tensor = np.load('../conv/patch_embed_proj_lif2_output.npy')
    input_tensor = np.load('../conv/patch_embed_maxpool2_output.npy') #TB合并了
    ...
    output_tensor = np.load('../conv/patch_embed_proj_lif3_output.npy')
